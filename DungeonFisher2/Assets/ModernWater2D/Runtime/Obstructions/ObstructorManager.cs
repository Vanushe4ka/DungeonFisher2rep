...
namespace Water2D
{
    ...
    public class ObstructorManager : WaterFeatureLayerRenderer
    {
        ...
        public LayerRenderer layerRenderer
        {
            get
            {
                if (_layerRenderer == null)
                {
                    ...
                    _layerRenderer.Setup(mainCamera, transform, rlayer, new Vector2(1.25f, 1.25f),textureResolution.value, RenderTextureFormat.RG16);
                }
        ...
        private void OnEnable()
        {
            ...
            layerRenderer.Setup(mainCamera, transform, rlayer, new Vector2(1.25f, 1.25f),textureResolution.value,  RenderTextureFormat.RG16);
            UpdateReflectionsShader();
        }
